<template>
  <div class="page">
    ...
    <el-row :gutter="16" class="base-grid">
      <el-col :xs="24" :sm="12" :md="8" :lg="6" v-for="item in bases" :key="item.id">
        <el-card class="base-card" shadow="hover" @click="selectBase(item.id)">
      ...
      <el-col :xs="24" :sm="12" :md="8" :lg="6">
        <el-card class="base-card base-card--dashed" @click="showCreateDialog = true">
    ...
    <el-card v-if="selectedBaseId" class="files-card" shadow="never">
      ...
      <el-table :data="files" v-loading="loadingFiles" size="small" border>
    ...
    <el-dialog title="新建知识库" v-model="showCreateDialog" width="360px">
      <el-form @submit.prevent>
        <el-form-item label="名称">
          <el-input v-model="newBaseName" placeholder="输入知识库名称" />
        </el-form-item>
      </el-form>
      <template #footer>
...
const createBase = async () => {
  ...
  creating.value = true;
  try {
    await createKnowledgeBase(newBaseName.value.trim());
