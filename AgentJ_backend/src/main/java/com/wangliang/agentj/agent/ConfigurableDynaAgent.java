...
import com.wangliang.agentj.tools.TerminableTool;
...
public class ConfigurableDynaAgent extends DynamicAgent {
    ...
    public List<ToolCallback> getToolCallList() {
        ...
        for (String toolKey : availableToolKeys) {
            ...
            if (toolCallBackContext.containsKey(lookupKey)) {
                PlanningFactory.ToolCallBackContext toolCallback = toolCallBackContext.get(lookupKey);
                ...
                PlanningFactory.ToolCallBackContext foundCallback = findToolByUnqualifiedName(toolCallBackContext, lookupKey);
        ...
        if (!hasTerminableTool) {
            ...
            PlanningFactory.ToolCallBackContext terminateToolContext = findToolByUnqualifiedName(toolCallBackContext,
                    TerminateTool.name);
     ...
     */
    private PlanningFactory.ToolCallBackContext findToolByUnqualifiedName(Map<String, PlanningFactory.ToolCallBackContext> toolCallBackContext,
        ...
        if (serviceGroupIndexService != null) {
            try {
                PlanningFactory.ToolCallBackContext found = findToolByServiceGroupAndName(toolCallBackContext, unqualifiedName);
                if (found != null) {
                    return found;
                }
            } catch (Exception e) {
     ...
     * @return The matching ToolCallBackContext or null if not found
     */
    private PlanningFactory.ToolCallBackContext findToolByServiceGroupAndName(Map<String, PlanningFactory.ToolCallBackContext> toolCallBackContext,
                                                                              String toolName) {
        try {
