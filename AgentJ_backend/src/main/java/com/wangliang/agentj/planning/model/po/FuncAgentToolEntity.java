 ...
 */
package com.wangliang.agentj.planning.model.po;

import com.wangliang.agentj.planning.model.converter.PlanTemplateAccessLevelConverter;
...
public class FuncAgentToolEntity {
	...
	@Convert(converter = PlanTemplateAccessLevelConverter.class)
